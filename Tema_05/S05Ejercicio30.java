...
public class S05Ejercicio30 {
  public static void main(String[] args) {
    ...
    do {
      ...
      // Comprueba que el segint primerDia = 0;
    int segundoDia = 0;
    int primeraHora = 0;
    int segundaHora = 0;
    String primerDiaString;
    ...
    do {
      ...
      do {
        ...
        if (!diaCorrecto) {
          System.out.println("No se ha introducido correctamente el día de la semana.");
          System.out.print("Los días válidos son: lunes, martes, miércoles, jueves, viernes, sábado y domingo.");
        }
    ...
    // FINAL
    System.out.print("Entre las " + primeraHora + ":00h del " + nombrePrimerDia + " y las " + segundaHora + ":00h del " + nombreSegundoDia);
